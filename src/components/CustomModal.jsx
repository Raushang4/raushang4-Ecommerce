...
export default function CustomModal({ id = 'custom-modal', isOpen, type, message, onClose }) {
  ...
  useEffect(() => {
    ...
    if (isOpen) {
      ...
      // Auto-focus the close button after a short delay for animation
      timer = setTimeout(() => {
        ...
        >
          ...
          >
            ...
            <button 
              ...
              ref={buttonRef}
              onClick={onClose} 
              className="w-full py-3 rounded-full font-bold transition-all text-white hover:opacity-90 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-current focus:outline-none"
