...
export default function CustomModal({ id, isOpen, type, message, onClose }) {
  ...
  useEffect(() => {
    ...
    if (isOpen) {
      ...
      // Auto-focus the close button when opened for accessibility
        ...
        >
          ...
          >
            ...
            <button 
              ...
              ref={closeBtnRef}
              onClick={onClose} 
              className="w-full py-3 rounded-full font-bold transition-all text-white hover:opacity-90 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-teal-500"
