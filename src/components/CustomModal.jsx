        ...
        >
          ...
          >
            ...
            <button 
              ...
              ref={buttonRef}
              onClick={onClose} 
              className="w-full py-3 rounded-full font-bold transition-all text-white hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
