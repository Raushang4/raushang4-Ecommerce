      ...
      <div id="footer-inner" className="footer-inner">
        <div id="footer-top" className="footer-top">
          ...
          <div id="footer-col-solutions" className="footer-col">
            <div id="label-solutions" className="footer-col-label" style={{ color: '#aaa' }}>Solutions</div>
          ...
          <div id="footer-col-industries" className="footer-col">
            <div id="label-industries" className="footer-col-label" style={{ color: '#aaa' }}>Industries</div>
          ...
          <div id="footer-col-company" className="footer-col">
            <div id="label-company" className="footer-col-label" style={{ color: '#aaa' }}>Company</div>
        ...
        <div id="footer-bottom" className="footer-bottom">
          <p id="footer-copy" className="footer-copy" style={{ color: '#aaa' }}>© 2026 raushang4 E-Commerce. All rights reserved. | Powered by raushang4 Technology</p>
          <div id="footer-policy" className="footer-policy">
            <Link id="policy-privacy" href="/legal/terms-of-use" style={{ color: '#aaa' }}>Privacy Policy</Link>
            <Link id="policy-terms" href="/legal/terms-of-use" style={{ color: '#aaa' }}>Terms of Use</Link>
          </div>
        </div>
      </div>
    </footer>
