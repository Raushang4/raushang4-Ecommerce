      ...
      <div id="footer-inner" className="footer-inner">
        ...
        <div id="footer-bottom" className="footer-bottom">
          ...
          <div id="footer-policy" className="footer-policy">
            <Link id="policy-privacy" href="/legal/terms-of-use" style={{ color: "#d1d5db" }} style={{ color: "#d1d5db" }} style={{ color: "#d1d5db" }}>Privacy Policy</Link>
            <Link id="policy-terms" href="/legal/terms-of-use" style={{ color: "#d1d5db" }} style={{ color: "#d1d5db" }} style={{ color: "#d1d5db" }}>Terms of Use</Link>
          </div>
        </div>
      </div>
    </footer>
