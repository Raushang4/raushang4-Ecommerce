      ...
      <div id="footer-inner" className="footer-inner">
        <div id="footer-top" className="footer-top">
          ...
          <div id="footer-col-solutions" className="footer-col">
            ...
            <ul id="links-solutions" className="footer-col-links">
              <li><a id="link-sol-1" href="/ecommerce-design-build">Ecommerce Design & Build</a></li>
              <li><a id="link-sol-2" href="/web-design">Web Design & Development</a></li>
              <li><a id="link-sol-3" href="/performance-marketing">Performance Marketing</a></li>
            </ul>
          </div>
          <div id="footer-col-industries" className="footer-col">
            ...
            <ul id="links-industries" className="footer-col-links">
              <li><a id="link-ind-1" href="/d2c-ecommerce">D2C & Ecommerce</a></li>
              <li><a id="link-ind-2" href="/manufacturers">Manufacturers</a></li>
            </ul>
          </div>
          <div id="footer-col-company" className="footer-col">
            ...
            <ul id="links-company" className="footer-col-links">
              <li><a id="link-cmp-1" href="/about">About</a></li>
              <li><a id="link-cmp-2" href="/contact">Contact</a></li>
            </ul>
          </div>
        </div>
        <div id="footer-bottom" className="footer-bottom">
          ...
          <div id="footer-policy" className="footer-policy">
            <a id="policy-privacy" href="/legal/terms-of-use">Privacy Policy</a>
            <a id="policy-terms" href="/legal/terms-of-use">Terms of Use</a>
          </div>
        </div>
      </div>
    </footer>
