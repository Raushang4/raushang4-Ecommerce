...
export default function ContactPage() {
  ...
  return (
    <>
      <div className="hero-wrap" role="region" aria-label="Hero">
        <div className="hero"> 
      ...
      <section className="contact-section"> 
        <div className="section-inner"> 
          <div className="contact-grid">  
            <div className="form-col" role="region" aria-label="Contact Form">
            ...
            <div className="contact-right" role="region" aria-label="Contact Information">
              <div> 
      ...
      <section className="footer-cta-section" role="region" aria-label="Footer Call to Action">
